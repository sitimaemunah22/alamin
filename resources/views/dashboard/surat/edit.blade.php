          ...
          <div class="card" style="margin-left: 200px; height: 400px; width:800px;">
                <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-group">
                            <form action="{{ route('simpan.donatur') }}" method="post">
                                {{ csrf_field() }}
                                <input type="number" id="kode" name="kode_donatur" class="form-control" placeholder="kode_donatur" value="{{ $pemasukan->kode_donatur }}">
                            </div>
                            <div class="form-group">
                                <input type="number" id="id" name="id_jenis_pemasukan" class="form-control" placeholder="id_jenis_pemasukan" value="{{ $pemasukan->id_jenis_pemasukan }}">
                            </div>
                            <div class="form-group">
                                <input type="number" id="id" name="id_donatur" class="form-control" placeholder="id_donatur" value="{{ $pemasukan->id_donatur }}">
                            </div>
                            <div class="form-group">
                                <input type="number" id="jumlah" name="jumlah_pemsukan" class="form-control" placeholder="jumlah_pemsukan"  value="{{ $pemasukan->jumlah_pemsukan }}">
                            </div>
                            <div class="form-group">
