                        ...
                        <div class="mb-3">
                            <div class="form-group">
                              <h3 class="text-center mb-4">Tambah Data</h3>
                                <!-- <input type="text" id="kode" name="kode" class="form-control" placeholder="Kode jenispemasukan"> -->
                            </div>

                            <form action="{{ route('simpan.jenispengeluaran') }}" method="post">
                              {{ csrf_field() }}
                            <div class="form-group">
                                <input type="string" id="nama_pengeluaran" name="nama_pengeluaran" class="form-control" placeholder="Nama Pengeluaran">
                            </div>
