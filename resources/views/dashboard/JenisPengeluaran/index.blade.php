                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="/dashboard/jenispengeluaran/tambah" class="btn btn-success">Tambah Data<i
                            ...
                            <tbody>
                                @foreach ($jenis_pengeluaran as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->aksi }}
                                            <a href="/dashboard/jenispengeluaran/edit/{{ $item->id_jenis_pengeluaran }}"
                                                class="btn btn-success">Edit</a>
                                            <a href="/dashboard/jenispengeluaran/hapus"
                                                class="btn btn-success ">Hapus</a>
                                            <a href="/dashboard/jenispengeluaran/detail/{{ $item->id_jenis_pengeluaran }}"
