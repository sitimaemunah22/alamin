                    ...
                    <div class="mb-3">
                        ...
                        <form action="{{ route('simpan.donatur') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group my-2">
                                <label for="">id_donatur</label>
                                <input type="string" id="id_donatur" name="id_donatur" class="form-control"
                                    placeholder="id_donatur">
                            </div>
                            ...
                            <div class="form-group my-2">
                                ...
                                <textarea name="alamat" id="alamat" cols="10" rows="10" style="height: 100px; width: 400px"
                                    class="mt-2" placeholder=" Alamat"></textarea>
                            </div>
                            <div class="form-group my-2">
