                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="/dashboard/donatur/tambah" class="btn btn-success">Tambah Data <i
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach ($data as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ url('donatur') . '/' . $item->upload }} "
                                            style="max-width: 100px; height: auto;" alt="Donatur" />
                                    </td>
                                    <td>{{ $item->aksi }}
                                        <a href="/dashboard/donatur/edit/{{ $item->id_donatur }}"
                                            class="btn btn-success">Edit</a>
                                        <a href="/dashboard/donatur/hapus" class="btn btn-success ">Hapus</a>
                                        <a href="/dashboard/donatur/detail/{{ $item->id_donatur }}"
