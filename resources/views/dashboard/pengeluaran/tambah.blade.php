                ...
                <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                              <h3 class="text-center mb-4">Tambah Data Pengeluaran</h3>
                            ...
                            <form action="{{ route('simpan.pengeluaran') }}" method="post">
                                {{ csrf_field() }}
                                <input type="number" id="kode" name="kode_pengeluaran" class="form-control" placeholder="kode_pengeluaran">
                            </div>
                            <div class="form-group">
                                <input type="number" id="id" name="id_jenis_pengeluaran" class="form-control" placeholder="id_jenis_pengeluaran">
                            </div>
                            <div class="form-group">
                                <input type="number" id="jumlah" name="jumlah_pengeluaran" class="form-control" placeholder="jumlah_pengeluaran">
                            </div>
                            <div class="form-group">
                                <input type="date" id="tanggal" name="tanggal_pengeluaran" class="form-control" placeholder="tanggal_pengeluaran">
                            </div>
