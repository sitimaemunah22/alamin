                    ...
                    <form action="{{ route('simpan.pemasukan') }}" method="post">
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input type="string" id="kode_pemasukan" name="kode_pemasukan" class="form-control"
                                    placeholder="kode_pemasukan" value="{{ $pemasukan->kode_pemasukan }}">

                                <input type="text" id="id_jenis_pemasukan" name="id_jenis_pemasukan" class="form-control"
                                    value="{{ $pemasukan->id_jenis_pemasukan }}" hidden>

                                <input type="text" id="id_doatur" name="id_doatur" class="form-control"
                                    value="{{ $pemasukan->id_doatur }}" hidden>

                                    <input type="text" id="jumlah_pemasukan" name="jumlah_pemasukan" class="form-control"
                                    value="{{ $pemasukan->jumlah_pemasukan }}" hidden>
    
                                    <input type="text" id="tanggal_pemasukan" name="tanggal_pemasukan" class="form-control"
                                    value="{{ $pemasukan->tanggal_pemasukan }}" hidden>
                                  </div>
