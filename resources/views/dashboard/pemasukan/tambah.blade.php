                    ...
                    <div class="mb-3">
                        ...
                        <form action="{{ route('simpan.pemasukan') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group my-2">
                                ...
                                <select name="id_jenis_pemasukan" id="id_jenis_pemasukan"
                                    class="form-select form-control">
                                    <option value="" disabled selected>Pilih Jenis Pemasukan</option>
                                    @foreach ($jenis_pemasukan as $data)
                                        <option value="{{ $data->id_jenis_pemasukan }}">{{ $data->nama_pemasukan }}
                                        </option>
                                    @endforeach
                                </select>

                                @error('id_jenis_pemasukan')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group my-2">
                                ...
                                <select name="id_donatur" id="id_donatur" class="form-select form-control">
                                    <option value="" disabled selected>Pilih Donatur</option>
                                    @foreach ($donatur as $item)
                                        <option value="{{ $item->id_donatur }}">{{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                @error('id_donatur')
                                    <span class="text-danger">{{ $message }}</span>
                            ...
                            <div class="form-group my-2">
                                ...
                                <input type="number" id="jumlah_pemsukan" name="jumlah_pemsukan"
                                    class="form-control" placeholder="jumlah_pemsukan">
                                    @error('jumlah_pemsukan')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group my-2">
