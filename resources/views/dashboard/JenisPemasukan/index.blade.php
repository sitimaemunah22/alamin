                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="/dashboard/jenispemasukan/tambah" class="btn btn-success">Tambah Data<i
                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($jenis_pemasukan as $item)
                                    <!-- Isi tabel disini -->
                                    <tr>
                                        <td>{{ $item->id_jenis_pemasukan }}</td>
                                        <td>{{ $item->nama_pemasukan }}</td>
                                        <td>{{ $item->aksi }}
                                            <a href="/dashboard/jenispemasukan/edit/{{ $item->id_jenis_pemasukan }}"
                                                class="btn btn-success">Edit</a>
                                            <a href="/dashboard/jenispemasukan/hapus"
                                                class="btn btn-success ">Hapus</a>
                                            <a href="/dashboard/jenispemasukan/detail/{{ $item->id_jenis_pemasukan }}"
